...
<sf:form method="POST" action="${saveUrl}" modelAttribute="element" class="form-horizontal">
	<div class="form-header">
		<h3 id="form-header-title"><s:message code="~de.unibamberg.minf.dme.form.nonterminal.edit" /></h3>	
		<sf:hidden path="id" />
	</div>
	<div class="form-content">
		<fieldset<c:if test="${readonly}"> disabled</c:if>>
			<div class="form-group">
				...
				<div class="col-sm-8">
					<sf:input path="name" class="form-control" id="nonterminalImpl_name" />
			...
			<div class="form-group">
				<div class="col-sm-8 col-sm-offset-3">
					<div class="checkbox">
						<label><sf:checkbox path="transient" /> <s:message code="~de.unibamberg.minf.dme.model.element.transient" /></label>
					</div>
				</div>
			</div>
