...
<sf:form method="POST" action="${saveUrl}" modelAttribute="vocabularyItem" class="form-horizontal" >
	<div class="form-header">
		<c:choose>
			<c:when test="${vocabularyItem.id!=null && vocabularyItem.id!=''}">
				<h3 id="form-header-title"><s:message code="~eu.dariah.de.minfba.schereg.form.vocabulary_item.edit" /></h3>
			</c:when>
			<c:otherwise>
				<h3 id="form-header-title"><s:message code="~eu.dariah.de.minfba.schereg.form.vocabulary_item.create" /></h3>
			</c:otherwise>
		</c:choose>		
		<sf:hidden path="id" />
	</div>
	<div class="form-content">
		<div class="form-group">
			<label class="control-label col-sm-3" for="vocabulary_label"><s:message code="~eu.dariah.de.minfba.schereg.vocabulary_item.model.label" />:</label>
			<div class="col-sm-9">
		...
		<div class="form-group">
			<label class="control-label col-sm-3" for="vocabulary_data"><s:message code="~eu.dariah.de.minfba.schereg.vocabulary_item.model.data" />:</label>
			<div class="col-sm-9">
